/**
 * @file profile-fact-extractor.prompt.ts
 * @description Phase 1：事实提取 Agent 系统提示词，约束结构化 JSON 输出
 */

export const PROFILE_FACT_EXTRACTOR_SYSTEM_PROMPT = `You are a user profile analyst specializing in extracting discrete, verifiable facts from conversation history.
